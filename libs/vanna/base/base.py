...
class VannaBase(ABC):
    ...
    def generate_summary(self, question: str, df: pd.DataFrame, **kwargs) -> str:
        ...
        **Example:**
        ...
        message_log = [
            self.system_message(
                f"You are a helpful data analyst assistant. The user asked the question: '{question}'\n\nThe following is a pandas DataFrame with the results of the query: \n{df.to_markdown()}\n\n"
            ),
            self.user_message(
                "Briefly summarize the data based on the question that was asked. Add $ symbol where necessary. Convert decimals to percentages where necessary. Limit decimals to two digits. Do not respond with any additional explanation beyond the summary." +
                self._response_language()
            ),
        ]
